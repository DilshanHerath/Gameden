            ...
            <div class="col-md-4 mt-5" style="position: relative">
                <div class="row mx-1" style="background-color: #020312">
                    <div class="col-6 mt-4">
                        <p class="font-clash-display fs-5 mb-2 text-white">Battlefield 5</p>
                        <p class="font-manrope-regular" style="color: #CCCCCF">Rerum debitis voluptates molestias.</p>
                        <div class="d-flex">
                ...
                <div class="col-md-6">
                    <form>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control rounded-0 form_input">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Email</label>
                            <input type="email" class="form-control rounded-0 form_input"
                                   placeholder="name@example.com">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Phone</label>
                            <input type="number" class="form-control rounded-0 form_input">
                        </div>
                        <div class="mb-3">
